...
/* harmony import */ var _slider_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slider/slider */ "./src/js/slider/slider.js");

var firstSlider = new _slider_slider__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
/***/ "./src/js/slider/lib/privateSlider.js":
/*!********************************************!*\
  !*** ./src/js/slider/lib/privateSlider.js ***!
  \********************************************/
/*! exports provided: default */
...
var PrivateSlider = /*#__PURE__*/function () {
  function PrivateSlider(slider) {
    _classCallCheck(this, PrivateSlider);

    this._slider = slider;
  }

  _createClass(PrivateSlider, [{
    key: "setOptions",
    ...
    value: function setTemplate() {
      var options = this.getOptions();
      var sliderListWrapper = document.createElement('div');
    ...
    value: function setDots() {
      var options = this.getOptions();
      var dotTemplate = options.dotsTemplate;
    ...
    key: "setDotsList",
    value: function setDotsList(dotTemplate) {
      var options = this.getOptions();
      var dotLi;
      var dotsSize = this.getDotsSize(options.dotsSize);
      var countDots = this.getCountDots();
      this._slider.dotList = [];
    }
  }, {
    key: "getCountDots",
    value: function getCountDots() {
      var options = this.getOptions();
      return options.dotsImageView ? this._slider.countSlide : Math.ceil(this._slider.countSlide / this._slider.slidesToShow);
    }
  }, {
    key: "getDotsSize",
    value: function getDotsSize(dotsSizeString) {
    ...
    value: function setArrow() {
      var options = this.getOptions();
      var arrowTemplate = options.arrowsTemplate;
    ...
    key: "getHtmlToString",
    value: function getHtmlToString(stringNode) {
    ...
    value: function setTrackPosition() {
      var _this = this;

      setTimeout(function () {
        _this._slider.sliderTrack.style.transform = "translate(".concat(_this.setTrackOffset(), "px)");
      }, 0);
    }
  }, {
    key: "setTrackOffset",
    value: function setTrackOffset() {
      var options = this.getOptions();
      var offset = -this._slider.offsetSlide;
    ...
    value: function buildSlider() {
      ...
      var options = this.getOptions();
      var sliderList = this._slider.sliderList;
      var sliderTrack = this._slider.sliderTrack;
      sliderList.forEach(function (slideItem, i) {
        slideItem.style.width = "".concat(_this2._slider.offsetSlide, "px");
        slideItem.dataset.slideIndex = i;
        sliderTrack.append(slideItem);
      });
      if (!options.infinity) return;
      var cloneItemStart = sliderList.filter(function (slideItem, i) {
        return i >= _this2._slider.countSlide - _this2._slider.slidesToShow;
      }).map(function (sliderItem) {
        return sliderItem.cloneNode(true);
      });
      var cloneItemEnd = sliderList.filter(function (slideItem, i) {
        return i < _this2._slider.slidesToShow;
      }).map(function (sliderItem) {
        return sliderItem.cloneNode(true);
      });
      cloneItemStart.reverse().forEach(function (itemSlide) {
        sliderTrack.prepend(itemSlide);
      });
      cloneItemEnd.forEach(function (itemSlide) {
        sliderTrack.append(itemSlide);
      });
    }
  }, {
    key: "setSliderTrack",
    value: function setSliderTrack() {
      var options = this.getOptions();
    ...
    value: function setTrackWidth() {
      var options = this.getOptions();
      var width = this._slider.offsetSlide * this._slider.countSlide;
      options.infinity && (width += this._slider.offsetSlide * this._slider.slidesToShow * 2);
      this._slider.trackWidth = width;
      this._slider.sliderTrack.style.width = "".concat(width, "px");
    }
  }, {
    key: "setOffsetSlide",
    value: function setOffsetSlide() {
      var options = this.getOptions();
      this._slider.offsetSlide = +(options.wrapper.offsetWidth / this._slider.slidesToShow).toFixed(1);
    }
  }, {
    key: "setSliderList",
    value: function setSliderList() {
      var options = this.getOptions();
      this._slider.sliderList = _toConsumableArray(options.wrapper.children).map(function (slide) {
    ...
    value: function addClass() {
      ...
      Array.prototype.slice.call(arguments).forEach(function (itemClass) {
        if (itemClass) {
          var _this3$classList;

          itemClass = itemClass.split(' ');

          (_this3$classList = _this3.classList).add.apply(_this3$classList, _toConsumableArray(itemClass));
        }
      });
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (PrivateSlider);
...
/* harmony import */ var _lib_defaults__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lib/defaults */ "./src/js/slider/lib/defaults.js");
/* harmony import */ var _lib_privateSlider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./lib/privateSlider */ "./src/js/slider/lib/privateSlider.js");
...
var Slider = /*#__PURE__*/function () {
  function Slider() {
    ...
    var customSliderClass = userOptions.sliderClass;
    var customArrowClass = userOptions.arrowsClass;
    var customDotClass = userOptions.dotsClass;
    ...
    this.options = _objectSpread(_objectSpread(_objectSpread({}, _lib_defaults__WEBPACK_IMPORTED_MODULE_7__["default"]), userOptions), {}, {
      customSliderClass: customSliderClass,
      customArrowsClass: customArrowClass,
      customDotsClass: customDotClass
    });
    this._privateSilder = new _lib_privateSlider__WEBPACK_IMPORTED_MODULE_8__["default"](this);
