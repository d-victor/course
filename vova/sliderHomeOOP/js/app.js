function slider() {
    ...
    function removeHtml(src, galleryWrapper) {
        galleryWrapper.removeChild(
            galleryWrapper.querySelector('[src="' + src + '"]')
        );
    }
...
addBtn.addEventListener("click", function () {
    slider1.addCollection(
        prompt("Enter the item:", "img/01.jpg|alt:ffff,title:my image"),
        function () {
...
removeBtn.addEventListener("click", function () {
    slider1.removeCollection(
        prompt("Enter the removed src:", "img/01.jpg"),
