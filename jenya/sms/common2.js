(function () {
    ...
    (function () {
        function ChatMessager(options) {
            ...
            function percentRate(like, allRate){
            ...
            function rating(e) {
                var messageId = e.currentTarget.dataset.btnId,
                    ...
                    // console.log(message.allRateCounter);
                    ...
                    // console.log(percentRate(message.rating.like, message.allRateCounter));
                    message.percentRate = percentRate(message.rating.like, message.allRateCounter);
                    this.options.formMessages.querySelector('.percent').textContent = message.percentRate + '%  of positive votes';

                    saveLocalStorage('chat', messageList);
                    
                // this.options.formMessages.querySelector('[data-id="' + messageId + '"] .footer .ratingLike').textContent = ratingData;
                // this.options.formMessages.querySelector('[data-id="' + messageId + '"] .footer .ratingDislike').textContent = ratingData;
            }
            ...
            function addMessage(message) {
                ...
                percentText.textContent = percent + '% of positive votes';
